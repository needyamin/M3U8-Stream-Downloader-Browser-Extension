// Universal Media Downloader - Background Script (Firefox Compatible)
...
class MediaDownloader {
  ...
  addDetectedStream(url, tabId) {
    ...
    // Notify popup if open - Firefox compatible
    ...
    try {
      switch (request.type) {
        ...
        case 'DOWNLOAD_STREAM':
          await this.downloadStream(request.streamId, request.options);
