// Content script for Universal Media Downloader (Firefox Compatible)
...
class MediaContentDetector {
  ...
  scanTextContent() {
    ...
    const mediaRegex = /https?:\/\/[^\s]+\.(mp4|avi|mkv|mov|wmv|flv|webm|m4v|3gp|ogv|ts|m2ts|mp3|wav|flac|aac|ogg|wma|m4a|opus|m3u8|mpd)[^\s]*/gi;
